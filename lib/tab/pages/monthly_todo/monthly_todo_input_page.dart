...
/// 以下の責務を持つ
/// ・Todo入力画面の状態を生成する
class MonthlyTodoInputPage extends StatefulWidget {
  /// Todoのモデル
  final MonthlyTodo? todo;

  /// コンストラクタ
  /// Todoを引数で受け取った場合は更新、受け取らない場合は追加画面となる
  const MonthlyTodoInputPage({Key? key, this.todo}) : super(key: key);

  /// Todo入力画面の状態を生成する
  @override
  State<MonthlyTodoInputPage> createState() => _MonthlyTodoInputPageState();
}
...
/// ・Todoを追加/更新する
/// ・Todoリスト画面へ戻る
class _MonthlyTodoInputPageState extends State<MonthlyTodoInputPage> {
  /// ストア
